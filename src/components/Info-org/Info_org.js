...
const Info_org = () =>{
  return(
    <section className="section-info-org">
      <button className="button-info-org" id="button-mision" onClick={show_mision}>Misión</button>
      <button className="button-info-org" id="button-vision" onClick={show_vision}>visión</button>
      <button className="button-info-org" id="button-valores" onClick={show_values}>valores</button>
      <div className="container-info-org">
        ...
        <div className="div-info-org container-mision">
          ...
          <div className="box-text-info-org">
            ...
            <p className="text-info-org">PODEROSAS es una ONG de Educación Integral para la Sexualidad (EIS) con el compromiso de reforzar el poder de decisión de adolescentes y jóvenes entre los 13 y 20 años de edad en comunidades de mayor grado de vulnerabilidad en Colombia, mediante círculos extracurriculares basado en un currículo de derechos sexuales y reproductivos con enfoque de género.</p>
          </div>
        </div>
        <div className="div-info-org container-vision">
          ...
          <div className="box-text-info-org">
            ...
            <p className="text-info-org">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet similique minima, repellendus unde ratione beatae tempora aliquid cumque omnis ut voluptas autem, fuga excepturi temporibus delectus vitae numquam labore corporis.</p>
          </div>
        </div>
